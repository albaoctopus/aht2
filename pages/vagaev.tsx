...
<div className="py-3 object-cover object-center h-91 w-full">
  <video src="/Vagaev.mp4" autoPlay loop muted controls className="rounded-3xl border-red-600 border-4 "/>
</div>

<div className="p-5 border-4 border-red-600 rounded-3xl items-center justify-between">
  <div className=" flex flex-col text-left">
    <p className="my-1 bg-red-800 text-white text-center text-lg font-extrabold rounded-3xl py-2 px-4 border-2 border-red-600 transition duration-200 ease-in-out hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Vagaev</p>
