export const Tlineone = () => (
    <section className="dark:dark:bg-gray-800 dark:dark:text-gray-100">
	<div className="container mx-auto flex flex-col p-6">
		<h2 className="py-4 text-3xl font-bold text-center">ДОРОЖНАЯ КАРТА</h2>
		<div className="divide-y divide-gray-700">
			...
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:dark:text-violet-400">Step 2 </span>
					<span className="text-xl font-bold md:text-2xl">Выпуск фан токенов</span>
					<span className="mt-4 dark:dark:text-gray-300">Покупка фан токенов позволит всупить в ДАО</span>
				</div>
			</div>
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				<div className="flex items-center justify-center lg:col-span-1 col-span-full">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:dark:text-violet-400">Step 3</span>
					<span className="text-xl font-bold md:text-2xl">Создание ДАО</span>
					<span className="mt-4 dark:dark:bg-gray-800 dark:dark:text-gray-300">Прямое участие в жизни лиги. С помощью голосования вы сможете внести свой вклад в развитие.</span>
				</div>
			</div>
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				<div className="flex items-center justify-center lg:col-span-1 col-span-full">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:dark:text-violet-400">Step 4</span>
					<span className="text-xl font-bold md:text-2xl">EARN TO PLAY Игра</span>
					<span className="mt-4 dark:dark:text-gray-300">Создание и запуск Play2Earn Игры. Бейся своим кумиром и зарабатывай.</span>
				</div>
			</div>
		</div>
	</div>
