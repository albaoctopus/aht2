...
import MarketBantam from "./MarketBantam";

function HeroBantam(props) {
  return (
  ...
  ОЛЕГ БОРИСОВ
      ...
      <div className="container  mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="basis-1/2  lg:grow lg:w-full md:w-1/2 w-5/6">
          <video className="object-cover object-center rounded-3xl" alt="hero" src="/Borisov.mp4" autoPlay loop muted />
        </div>
